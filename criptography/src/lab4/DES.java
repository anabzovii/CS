...
public class DES {
    ...
    //A 48-bit value is split into 6-bit sections, and each section is permuted into a different 6-bit value according to these eight tables.
    ...
    private static long[] createSubways(/* 64 bits */ long key) {
    ...
    public static long encryptBlock(long m, /* 64 bits */ long key) {
        ...
        long[] subkeys = createSubways(key);
    ...
    public static void main(String[] args) {
        String oriText = "welikecoffeeverymuch";
        String key = convertStringToHex("secret");
